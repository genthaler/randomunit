...
/**
 * A simple log that consists of a Method that has been invoked, the arguments that were used
 * for this invocation, and the value that the method returned, if any.
 *
...
public class MethodInvocationLog {
     ...
     *
     * @param method the method that was invoked (cannot be null)
     * @param args the arguments with which the method was invoked. If null, new Object[0] is implied
     * @param returnedValue the value that the method returned (or null if none)
     * @param targetPools the pools into which the returnedValue was appended
     */
    public MethodInvocationLog(Method method, PooledObject[] args, Object returnedValue, String[] targetPools) {
        if (method == null) {
    ...
    public static class PooledObject {
        ...
        /**
         * Creates a PooledObject instance, that described the specified object, which has been
         * appended to the given object pool.
         */
